...
/*   Updated: 2016/05/18 20:03:46 by tfolly           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//elle arrive des le premier frac->data[...] mauvais acces a data
	...
	frac->data[x + (int)frac->size * y] = (unsigned char)color1;
	frac->data[x + (int)frac->size * y + 1] = (unsigned char)color2;
	frac->data[x + (int)frac->size * y + 2] = (unsigned char)color3;
}
